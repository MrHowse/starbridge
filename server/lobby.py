...
class LobbySession:
    ...
    roles: dict[str, tuple[str, str] | None] = field(
        default_factory=lambda: {
            r: None
            for r in ("captain", "helm", "weapons", "engineering", "science", "medical", "security", "comms", "flight_ops", "electronic_warfare", "operations", "damage_control", "janitor", "quartermaster")
        }
    )
